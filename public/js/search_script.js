...
//            data:{keyword:$('#keyword').val(),_token:$('input[name="_token"]').val()},
...
//                  temp_html+= "<h1><a href='/asiantrade/public/post/detail/"+items[i]['id']+"'>"+items[i]['title']+"</a></h1> <hr>";
//                  temp_html+= "<div>";
...
//                              temp_html+= "<img class='product_avatar ' src='../uploads/images/"+items[i]['avatar']+"' alt='picture of product'>";
...
//        }
//        else
//        { $('#message_keyword').html("<p style='color:red;'> keyword should be more than 5 characters</p>");
//        $('#search_result').html('');
             ...
             for(var i=0;i<items.length;i++)
             {
               temp_html+="<div class='row-12 border border-warning mb-2 border-3 d-flex'>";
                               temp_html+= "<div class='col-8 border' >";
                                ...
                                temp_html+= "<h1><a href='/asiantrade/public/post/detail/"+items[i]['id']+"' target='_blank'>"+items[i]['title']+"</a></h1> <hr>";
                                temp_html+= "<div>";
                                temp_html+= "<p>"+items[i]['description']+"</p>";
                               temp_html+= "</div>";
                               temp_html+="</div>";
